...
* Execute the following command: `bower install iso-3166-country-codes-angular-es --save`
* Add this line in your dependencies: `"iso-3166-country-codes-angular-es": "1.2.1"`
